...
# gemini-2.5-flash was retired for new API keys; override with GEMINI_MODEL in .env.
GEMINI_MODEL = os.getenv("GEMINI_MODEL", "gemini-3.6-flash")
print("Google API key loaded:", bool(API_KEY))
...
@app.get("/")
def read_root():
    return {"status": "online", "message": "KrishiRakshak Crop Advisory Backend is running"}
...
def generate_image(prompt: str):
    ...
    api_url = f"https://generativelanguage.googleapis.com/v1beta/models/{image_model}:generateContent?key={API_KEY}"
