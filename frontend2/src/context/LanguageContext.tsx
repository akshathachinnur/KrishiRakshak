...
export const TRANSLATIONS: Record<AppLanguage, Translations> = {
  ...
  hi: {
    ...
    hero: {
      ...
      headline3: '',
      description: 'पौधे की तस्वीर खींचकर 3 सेकंड में फसल बीमारी की पहचान करें, मिट्टी NPK जांच से अधिक मुनाफे वाली फसल चुनें, और मंडियों के ताज़ा भाव जानें।',
      btnDiagnose: 'पौधे का रोग जांचें',
    ...
    pipeline: {
      ...
      step1Title: '1. पौधे की फोटो लें',
      step1Desc: 'अपने मोबाइल कैमरे से बीमार पौधे की साफ फोटो लें या गैलरी से अपलोड करें।',
      step2Title: '2. तुरंत AI से रोग पहचानें',
      step2Desc: 'आर्टिफिशियल इंटेलिजेंस पौधे की बीमारी, फफूंद का असर और गंभीरता तुरंत बताता है।',
    ...
    scanner: {
      badge: 'AI पौधा डॉक्टर',
      heading: 'फसल रोग पहचान व उपचार केंद्र',
      subheading: 'किसी भी फसल या पौधे की फोटो अपलोड करें और तुरंत सटीक बीमारी व दवा की जानकारी पाएं।',
      ...
      dragDropText: 'पौधे की फोटो यहां खींचें या गैलरी से चुनने के लिए क्लिक करें',
      cameraBtn: 'कैमरे से फोटो लें',
      uploadBtn: 'फोटो अपलोड करें',
      analyzing: 'AI पौधे की बीमारी की जांच कर रहा है...',
      resultsTitle: 'जांच परिणाम व उपचार सलाह',
      confidenceLabel: 'सटीकता',
      foliarDamage: 'पौधे का प्रभावित हिस्सा',
    ...
    vault: {
      ...
      subheading: 'पिछले सभी पौधे जांच रिकॉर्ड, दवाओं का छिड़काव और मिट्टी की योजनाएं सुरक्षित रखें।',
      totalScans: 'कुल जांच',
      ...
      noRecordsDesc: 'पौधे की जांच करें या मिट्टी की योजना बनाकर अपनी खेत डायरी में जोड़ें।',
      printExport: 'रिपोर्ट प्रिंट / पीडीएफ डाउनलोड करें',
      scanNew: 'नए पौधे की जांच करें',
    },
    chatbot: {
    ...
    footer: {
      ...
      scannerLink: 'पौधा डॉक्टर (रोग जांच)',
  ...
  en: {
    ...
    hero: {
      ...
      headline3: '',
      description: 'Snap a plant photo to diagnose crop diseases in 3 seconds with AI remedies, predict highest-profit crops with soil NPK, and check real-time Mandi market rates.',
      btnDiagnose: 'Diagnose Plant Disease',
    ...
    pipeline: {
      ...
      c2Desc: 'Visual symptoms go unnoticed until plant necrosis spreads across the entire field.',
    ...
    scanner: {
      ...
      heading: 'Plant Pathology & Disease Diagnostic',
      subheading: 'Upload or snap a photo of any crop plant to detect bacterial, fungal, or viral infections immediately.',
      ...
      dragDropText: 'Drag & Drop plant photo here or click to browse files',
      cameraBtn: 'Take Camera Photo',
      uploadBtn: 'Upload Plant Photo',
      analyzing: 'Analyzing plant pathology with AI...',
      resultsTitle: 'Diagnostic Summary & Pathology Report',
      confidenceLabel: 'Confidence',
      foliarDamage: 'Plant Damage Area',
    ...
    telemetry: {
      ...
      goodSun: 'Good Sun',
      sunDesc: 'Adequate light for plant photosynthesis',
    },
    schemes: {
    ...
    vault: {
      ...
      noRecordsDesc: 'Scan crop plants or generate soil crop recommendations to start saving your farm history.',
      printExport: 'Print / Export PDF',
      scanNew: 'Scan a New Plant',
    },
    chatbot: {
      ...
      welcome: 'Namaste Kisan Bhai! I am your KrishiRakshak farm companion. Ask me any farming question in your own language — plant disease medicines, natural pest remedies, sowing advice, or today\'s Mandi market rates.',
    ...
    footer: {
      ...
      scannerLink: 'Plant Doctor (Disease Scan)',
  ...
  mr: {
    ...
    hero: {
      ...
      headline3: '',
      description: 'रोपाचा फोटो काढून ३ सेकंदात पीक रोगाचे अचूक निदान मिळवा, माती परीक्षणावरून सर्वाधिक नफ्याचे पीक निवडा आणि थेट बाजार भाव तपासा.',
      btnDiagnose: 'रोपावरील रोग तपासा',
    ...
    pipeline: {
      ...
      step1Title: '१. रोपाचा फोटो काढा',
      step1Desc: 'मोबाईल कॅमेऱ्याने बाधित रोपाचा स्पष्ट फोटो काढा किंवा गॅलरीतून अपलोड करा.',
    ...
    scanner: {
      badge: 'AI रोप डॉक्टर',
      heading: 'रोपांचे रोग निदान व उपचार सल्ला',
      subheading: 'कोणत्याही पिकाच्या किंवा रोपाचा फोटो अपलोड करा आणि तत्काळ रोगाची माहिती व उपाय जाणून घ्या.',
      ...
      dragDropText: 'रोपाचा फोटो येथे ड्रॅग करा किंवा फाईल निवडण्यासाठी क्लिक करा',
      cameraBtn: 'कॅमेऱ्याने फोटो काढा',
      uploadBtn: 'फोटो अपलोड करा',
      analyzing: 'AI रोपाचे सूक्ष्म विश्लेषण करत आहे...',
      resultsTitle: 'तपासणी अहवाल व उपचार सल्ला',
      confidenceLabel: 'अचूकता',
      foliarDamage: 'रोपाचा बाधित भाग',
    ...
    vault: {
      ...
      subheading: 'पूर्वी तपासलेली रोपे, रोगांवरील फवारणी आणि माती शिफारसींचा इतिहास सुरक्षित ठेवा.',
      ...
      noRecordsDesc: 'रोपांची तपासणी करा किंवा मातीचे नियोजन करून आपल्या नोंदवहीत जोडा.',
      printExport: 'अहवाल प्रिंट / पीडीएफ डाऊनलोड करा',
      scanNew: 'नवीन रोप तपासा',
    },
    chatbot: {
    ...
    footer: {
      ...
      scannerLink: 'रोप डॉक्टर (रोग तपासणी)',
  ...
  kn: {
    ...
    hero: {
      ...
      headline3: '',
      description: 'ಗಿಡದ ಫೋಟೋ ತೆಗೆದು ಕೇವಲ 3 ಸೆಕೆಂಡುಗಳಲ್ಲಿ ರೋಗ ಪತ್ತೆಹಚ್ಚಿ, ಮಣ್ಣಿನ ಗುಣಲಕ್ಷಣಗಳ ಆಧಾರದ ಮೇಲೆ ಲಾಭದಾಯಕ ಬೆಳೆ ಆಯ್ಕೆಮಾಡಿ ಮತ್ತು ಮಾರುಕಟ್ಟೆ ದರ ತಿಳಿಯಿರಿ.',
      btnDiagnose: 'ಗಿಡದ ರೋಗ ಪರೀಕ್ಷಿಸಿ',
    ...
    pipeline: {
      ...
      step1Title: '1. ಗಿಡದ ಫೋಟೋ ತೆಗೆಯಿರಿ',
      step1Desc: 'ಮೊಬೈಲ್ ಕ್ಯಾಮೆರಾದಿಂದ ಪೀಡಿತ ಗಿಡದ ಸ್ಪಷ್ಟ ಚಿತ್ರ ತೆಗೆದುಕೊಳ್ಳಿ ಅಥವಾ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.',
    ...
    scanner: {
      ...
      subheading: 'ಯಾವುದೇ ಬೆಳೆಯ ಗಿಡದ ಫೋಟೋ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ ತಕ್ಷಣ ನಿಖರ ರೋಗ ಮತ್ತು ಔಷಧಿ ಮಾಹಿತಿ ಪಡೆಯಿರಿ.',
      ...
      dragDropText: 'ಗಿಡದ ಫೋಟೋವನ್ನು ಇಲ್ಲಿಗೆ ಎಳೆಯಿರಿ ಅಥವಾ ಫೈಲ್ ಆಯ್ಕೆ ಮಾಡಲು ಕ್ಲಿಕ್ ಮಾಡಿ',
      cameraBtn: 'ಕ್ಯಾಮೆರಾದಿಂದ ಫೋಟೋ ತೆಗೆಯಿರಿ',
      uploadBtn: 'ಫೋಟೋ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ',
      analyzing: 'AI ಗಿಡದ ಕಣಗಳನ್ನು ವಿಶ್ಲೇಷಿಸುತ್ತಿದೆ...',
      resultsTitle: 'ರೋಗ ಪತ್ತೆ ವರದಿ ಮತ್ತು ಚಿಕಿತ್ಸಾ ಮಾಹಿತಿ',
      confidenceLabel: 'ನಿಖರತೆ',
      foliarDamage: 'ಹಾನಿಯಾದ ಗಿಡದ ಶೇಕಡಾವಾರು',
    ...
    vault: {
      ...
      subheading: 'ಹಿಂದೆ ಪರೀಕ್ಷಿಸಿದ ಗಿಡಗಳು, ಸಿಂಪಡಿಸಿದ ಔಷಧಿಗಳು ಮತ್ತು ಮಣ್ಣಿನ ಶಿಫಾರಸುಗಳನ್ನು ಸುರಕ್ಷಿತವಾಗಿರಿಸಿ.',
      ...
      noRecordsDesc: 'ಗಿಡಗಳನ್ನು ಪರೀಕ್ಷಿಸಿ ಅಥವಾ ಮಣ್ಣಿನ ಬೆಳೆ ಶಿಫಾರಸು ಪಡೆದು ನಿಮ್ಮ ನೋಟ್‌ಬುಕ್‌ನಲ್ಲಿ ಉಳಿಸಿ.',
      printExport: 'ವರದಿ ಪ್ರಿಂಟ್ / ಪಿಡಿಎಫ್ ಡೌನ್‌ಲೋಡ್',
      scanNew: 'ಹೊಸ ಗಿಡ ಪರೀಕ್ಷಿಸಿ',
    },
    chatbot: {
    ...
    footer: {
      ...
      scannerLink: 'ಗಿಡ ವೈದ್ಯ (ರೋಗ ಪರೀಕ್ಷೆ)',
  ...
  te: {
    ...
    hero: {
      ...
      headline3: '',
      description: 'మొక్క ఫోటో తీసి 3 సెకన్లలో పంట తెగుళ్లను గుర్తించండి, నేల సారం ఆధారంగా అధిక లాభాన్నిచ్చే పంటలను ఎంచుకోండి మరియు మార్కెట్ ధరలను తెలుసుకోండి.',
      btnDiagnose: 'మొక్క తెగులును గుర్తించండి',
    ...
    pipeline: {
      ...
      step1Title: '1. మొక్క ఫోటో తీయండి',
      step1Desc: 'మొబైల్ కెమెరాతో తెగులు సోకిన మొక్క స్పష్టమైన ఫోటో తీయండి లేదా అప్‌లోడ్ చేయండి.',
    ...
    scanner: {
      badge: 'AI మొక్క డాక్టర్',
      heading: 'పంట తెగుళ్ల గుర్తింపు & నివారణ కేంద్రం',
      subheading: 'ఏదైనా పంట లేదా మొక్క ఫోటో అప్‌లోడ్ చేసి వెంటనే ఖచ్చితమైన తెగులు మరియు మందుల వివరాలు పొందండి.',
      ...
      dragDropText: 'మొక్క ఫోటోను ఇక్కడ లాగి వదలండి లేదా ఫైల్ ఎంచుకోవడానికి క్లిక్ చేయండి',
      cameraBtn: 'కెమెరాతో ఫోటో తీయండి',
      uploadBtn: 'ఫోటో అప్‌లోడ్ చేయండి',
      analyzing: 'AI మొక్కను నిశితంగా పరిశీలిస్తోంది...',
      resultsTitle: 'రోగ నిర్ధారణ నివేదిక & చికిత్సా సలహా',
      confidenceLabel: 'ఖచ్చితత్వం',
      foliarDamage: 'మొక్క దెబ్బతిన్న శాతం',
    ...
    vault: {
      ...
      noRecordsDesc: 'మొక్కలను తనిఖీ చేసి లేదా నేల సలహాలను మీ వ్యవసాయ పుస్తకంలో భద్రపరచండి.',
      printExport: 'నివేదిక ప్రింట్ / పీడీఎఫ్ డౌన్‌లోడ్',
      scanNew: 'కొత్త మొక్కను తనిఖీ చేయండి',
    },
    chatbot: {
    ...
    footer: {
      ...
      scannerLink: 'మొక్క డాక్టర్ (తెగుళ్ల గుర్తింపు)',
  ...
  gu: {
    ...
    hero: {
      ...
      headline3: '',
      description: 'છોડનો ફોટો પાડીને ૩ સેકન્ડમાં પાકના રોગની સચોટ ઓળખ અને દવા મેળવો, જમીન ચકાસણી મુજબ સૌથી વધુ નફો આપતો પાક પસંદ કરો અને આજના બજાર ભાવો જાણો.',
      btnDiagnose: 'છોડનો રોગ તપાસો',
    ...
    pipeline: {
      ...
      step1Title: '૧. છોડનો ફોટો પાડો',
      step1Desc: 'મોબાઇલ કેમેરાથી રોગિષ્ઠ છોડનો સ્પષ્ટ ફોટો લો અથવા ગેલેરીમાંથી અપલોડ કરો.',
    ...
    scanner: {
      ...
      subheading: 'કોઈપણ પાકના છોડનો ફોટો અપલોડ કરો અને તાત્કાલિક ચોક્કસ રોગ અને દવા વિશે જાણો.',
      ...
      dragDropText: 'છોડનો ફોટો અહીં લાવો અથવા ફાઇલ પસંદ કરવા ક્લિક કરો',
      cameraBtn: 'કેમેરાથી ફોટો પાડો',
      uploadBtn: 'ફોટો અપલોડ કરો',
      analyzing: 'AI છોડના કોષોનું પૃથક્કરણ કરી રહ્યું છે...',
      resultsTitle: 'રોગ નિદાન અહેવાલ અને ઉપચાર સલાહ',
      confidenceLabel: 'ચોકસાઈ',
      foliarDamage: 'છોડનો અસરગ્રસ્ત ભાગ',
    ...
    vault: {
      ...
      subheading: 'અગાઉ તપાસેલા છોડ, છાંટેલી દવાઓ અને જમીન ભલામણોનો ઈતિહાસ સુરક્ષિત રાખો.',
      ...
      noRecordsDesc: 'છોડની તપાસ કરો અથવા જમીનની ભલામણ મેળવીને તમારી નોંધપોથીમાં સાચવો.',
      printExport: 'અહેવાલ પ્રિન્ટ / પીડીએફ ડાઉનલોડ',
      scanNew: 'નવો છોડ તપાસો',
    },
    chatbot: {
    ...
    footer: {
      ...
      scannerLink: 'છોડ ડૉક્ટર (રોગ નિદાન)',
