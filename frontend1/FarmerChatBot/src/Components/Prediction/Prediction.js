...
const Prediction = () => {
  ...
  // gemini-2.5-flash is retired for new API keys. Override with REACT_APP_GEMINI_MODEL.
  const GEMINI_MODEL = process.env.REACT_APP_GEMINI_MODEL || "gemini-3.6-flash";
